...
def execute(programFile, taskFile, runtime_ms, cores, seed):
    ...
    return subprocess.check_output([programFile, taskFile, "--runtime", constraint.runtime_ms, "--cores", constraint.cores, "--seed", seed], timeout=runtime_ms/1000, universal_newlines=True)
